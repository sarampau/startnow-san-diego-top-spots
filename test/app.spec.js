...
describe('top spots', function () {
  ...
  it('should show a list of topspots as bootstrap wells', () =>
    ...
    .goto(url)
    .wait('#topspots')
    .evaluate(() => document.querySelectorAll('.spot').length)
    .end()
  ...
  it('should show topspot description in each bootstrap well using a <p> element.', () =>
    ...
    .goto(url)
    .wait('#topspots')
    .evaluate(() => Array.prototype.slice.call(document.querySelectorAll('div.spot>p')).map(el => el.innerHTML))
    .end()
    .then((descriptions) => {
  ...
  it('should show a link in each bootstrap well using an <a> element styled as a bootstrap button.', () =>
    ...
    .goto(url)
    .wait('#topspots')
    .evaluate(() => Array.prototype.slice.call(document.querySelectorAll('div.spot a')).map(el => el.attributes.href.nodeValue))
    .end()
    .then((links) => {
      console.log(links);
